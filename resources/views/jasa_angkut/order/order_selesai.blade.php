...
<body>
    <div class="phone-wrapper" id="phoneWrapper">
        ...
        <div class="info-card slide-up" style="animation-delay:1.05s;">
            ...
            <div class="info-row">
                <span style="font-size:13px;color:rgba(255,255,255,0.7);">Poin Didapat</span>
                <span style="font-size:13px;font-weight:700;color:#fff;">+{{ $pesanan->poin_didapat ?? 0 }} Poin</span>
            </div>
            <div class="info-row">
        ...
        <div style="width:100%;z-index:1;" class="slide-up" style="animation-delay:1.25s;">
            <a href="{{ route('jasa-angkut.index') }}" class="btn-dashboard slide-up" style="animation-delay:1.2s;">
            ...
            <a href="{{ route('jasa-angkut.riwayat') }}" class="btn-riwayat slide-up" style="animation-delay:1.35s;">
