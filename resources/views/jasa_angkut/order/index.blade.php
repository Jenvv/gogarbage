    ...
    <div class="phone-wrapper">
        ...
        <div class="header-green">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:6px;">
                <a href="{{ route('jasa-angkut.index') }}" style="background:none;border:none;cursor:pointer;padding:0;display:flex;align-items:center;text-decoration:none;">
            ...
            <div style="padding-bottom: 24px;">
                ...
                <div class="order-card" @if($loop->first) style="margin-top:16px;" @endif>
                    ...
                    <div style="display:flex;align-items:center;gap:5px;margin-bottom:14px;">
                        ...
                        <p style="font-size:12.5px;color:#6b7280;font-weight:400;">{{ $order->alamat_jemput }}</p>
                    </div>

                    <!-- Kategori Sampah Badges -->
                    <div class="kategori-badges">
                        @foreach($order->detailPesanan as $detail)
                        <span class="kategori-badge" style="color:#16a34a;background:#f0fdf4;border:1px solid #bbf7d0;">
                    ...
                    <div class="info-row">
                        <div class="info-item">
                            <div style="display:flex;align-items:center;gap:5px;">
                                <svg width="13" height="13" fill="none" stroke="#6b7280" stroke-width="2"
                                    viewBox="0 0 24 24">
                    ...
                    <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:10px;padding:10px 14px;margin-bottom:14px;">
                        <p style="font-size:11px;color:#92400e;font-weight:600;margin-bottom:2px;">Catatan:</p>
                    ...
                    <div style="display:flex;gap:12px;">
                        <form action="{{ route('jasa-angkut.order.tolak', $order->id) }}" method="POST" style="flex:1;">
                            @csrf
                            <button type="submit" class="btn-tolak" style="width:100%;" onclick="return confirm('Yakin ingin menolak order ini?')">Tolak</button>
                        </form>
                        <form action="{{ route('jasa-angkut.order.terima', $order->id) }}" method="POST" style="flex:1;">
                            @csrf
                ...
                <div style="margin:40px 16px;text-align:center;">
                    ...
                    <p style="font-size:13px;color:#9ca3af;">Belum ada order masuk saat ini.<br>Silakan cek kembali nanti.</p>
                </div>
                @endforelse
