    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4 md:gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div class="flex items-end justify-between mt-5">
                ...
                <span class="flex items-center gap-1 rounded-full bg-blue-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-blue-600 dark:bg-blue-500/15 dark:text-blue-500">Aktif</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            <div class="flex items-center justify-center w-12 h-12 bg-amber-100 rounded-xl dark:bg-amber-500/15">
                <svg class="fill-amber-600 dark:fill-amber-400" width="24" height="24" viewBox="0 0 24 24"><path d="M20 4H4v2h16V4zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6h1zm-9 4H6v-4h6v4z" fill=""/></svg>
            </div>
            <div class="flex items-end justify-between mt-5">
                <div>
                ...
                <span class="flex items-center gap-1 rounded-full bg-amber-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-amber-600 dark:bg-amber-500/15 dark:text-amber-500">Pengepul</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div class="flex items-end justify-between mt-5">
                ...
                <span class="flex items-center gap-1 rounded-full bg-purple-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-purple-600 dark:bg-purple-500/15 dark:text-purple-500">Kg</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-12 gap-4 mt-6 md:gap-6">
        <div class="col-span-12 xl:col-span-7">
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div class="h-[300px] flex items-center justify-center text-gray-400">
                    <p class="text-sm">Grafik akan ditampilkan setelah integrasi data</p>
                </div>
            </div>
        </div>
        <div class="col-span-12 xl:col-span-5">
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div class="h-[300px] flex items-center justify-center text-gray-400">
                    <p class="text-sm">Pie chart akan ditampilkan setelah integrasi data</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="p-5 md:p-6 overflow-x-auto">
                    <table class="min-w-full">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="5" class="py-8 text-center text-sm text-gray-400">Data akan ditampilkan setelah integrasi</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
