...
namespace App\Http\Controllers\JasaAngkut;
...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jasa_angkut.order.index', compact('orders'));
    }
    ...
    public function show($id)
    {
        ...
        return view('jasa_angkut.order.detail_order', compact('pesanan'));
    }
    ...
    public function terima($id)
    {
        ...
        return redirect()->route('jasa-angkut.order.proses-jemput', $pesanan->id)
    ...
    public function tolak($id)
    {
        ...
        return redirect()->route('jasa-angkut.order.index')
    ...
    public function prosesJemput($id)
    {
        ...
        return view('jasa_angkut.order.proses_jemput', compact('pesanan'));
    }
    ...
    public function selesaikanOrder(Request $request, $id)
    {
        ...
        if ($pesanan->total_pendapatan > 0) {
            return redirect()->route('jasa-angkut.order.pembayaran-berhasil', $pesanan->id)
                ->with('success', 'Order berhasil diselesaikan dan pembayaran dicatat!');
        }

        return redirect()->route('jasa-angkut.order.selesai', $pesanan->id)
    ...
    public function orderSelesai($id)
    {
        ...
        return view('jasa_angkut.order.order_selesai', compact('pesanan'));
    }
    ...
    public function pembayaranBerhasil($id)
    {
        ...
        return view('jasa_angkut.order.pembayaran_berhasil', compact('pesanan'));
    }
}
